...
define('smtppwd','zxcv1234') ;//email密码
...
define('usergr_power','dl#zx') ;//个人用户权限
define('shuxing_name','') ;//产品更多属性设置
define('tz','1万以下|1-10万|10-20万|20-50万|50-100万|100万以上') ;//投资额度设置
...
define('allowrepeatreg','No') ;//是否允许重复注册用户
define('showdlinzs','Yes') ;//招商信息内是否显示代理留言数
...
define('shuiyin','Yes') ;//是否启用水印功能
define('addimgXY','right') ;//水印位置
define('syurl','image/sy.png') ;//水印图片地址
