...
<div class="boxsave"> 
	...
	<li><a href="zx_manage.php?b=<?php echo $bigclassid?>&page=<?php echo $page?>">[返回]</a></li>
...
?>
	...
	<tr>
      <td align="right" class="border" >关联产品ID</td>
      <td class="border" ><input name="did" type="text" size="50" maxlength="255" /></td>
    </tr>
    <tr id="trimg">
	...
	<tr>
      <td align="right" class="border" >作者</td>
      <td class="border" ><input name="editor" type="text" size="50" maxlength="255" /></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      <td align="right" class="border" >关联产品ID</td>
      <td class="border" ><input name="did" type="text" value="<?php echo $rowzx["did"]?>" size="50" maxlength="255" /></td>
    </tr>
	<tr id="trkeywords">
      <td align="right" class="border" >封面图片</td>
	...
	<tr id="trkeywords">
      <td align="right" class="border" >作者</td>
      <td class="border" ><input name="editor" type="text" value="<?php echo $rowzx["editor"]?>" size="50" maxlength="255" /></td>
    </tr>
    <tr>
      <td align="right" class="border">&nbsp;</td>
	...
	<tr> 
      <td align="right" class="border">浏览量</td>
      <td class="border"> <input name="hit" type="text" id="hit" value="<?php echo $rowzx["hit"]?>" size="4" maxlength="3"></td>
    </tr>
    <tr> 
      <td align="right" class="border" >浏览权限</td>
      <td class="border" > <select name="groupid">
