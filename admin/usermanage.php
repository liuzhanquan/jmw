...
$userid=isset($_GET["id"])?$_GET["id"]:'';//翻页中会以GET传值 
...
?>
	...
	$rown=fetch_array($rsn);
      ...
      <td align="center" class="docolor"><a href="usermodify.php?id=<?php echo $row["id"]?>">修改</a> |
		...
		<br/>
			<a href="dlcollect.php?uid=<?php echo $row["id"]?>">产品收藏</a> | 
			<a href="footprint.php?uid=<?php echo $row["id"]?>">产品足迹</a> 
			<br/>
			<a href="pinglun_manage.php?uid=<?php echo $row["id"]?>">文章评论</a> | 
			<a href="dlmessage.php?uid=<?php echo $row["id"]?>">加盟申请</a> 
		</td>
    </tr>
    <?php
   }
