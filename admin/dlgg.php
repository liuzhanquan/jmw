...
?>
<form name="form1" method="post" action="?action=addgg">
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
	...
	<tr class="trcontent">  
      <td ><a name="S<?php echo $rown["classid"]?>"></a>
    <?php
	$n=0;
	...
	?>
		<!--img src="image/icosmall.gif" width="23" height="11"--> 
		<label style="margin-right:20px;">
		<input name="tagid[]" value="<?php echo $rown['classid'];?>" type="checkbox" <?php if( getadfind($rown['classname'],$rown['parentid'],$did) ){ echo 'checked';}?> />
        <?php echo $rown["classname"]?>
		</label>
