...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
	...
	?>
	  ...
	  <?php
	//if (str_is_inarr(channel,'dlje')=='yes'){
	?>
	  <li><a href="dlje.php?tablename=zzcms_dlje" target="frmright">代理金额区间类别</a></li>
	...
	//if (str_is_inarr(channel,'dlje')=='yes'){
	?>
	  <li><a href="dladvantag.php?tablename=zzcms_dladvantag" target="frmright">代理商家优势标签</a></li>
	  <li><a href="dltag.php?tablename=zzcms_dltag" target="frmright">代理商家支持标签</a></li>
	...
	<li><a href="class.php?tablename=zzcms_linkclass" target="frmright">友情链接类别</a></li> 
      ...
      <div id="left4" style="display:none"> 
		...
		<li><a href="showbad.php" target="frmright">用户不良操作记录</a></li>
      ...
      <div id="left5" style="display:none"> 
        ...
        <li><a href="uploadfile_nouse.php" target="frmright"> 清理无用的上传文件</a></li>
			...
			<li><a href="showbad.php" target="frmright">限制来访IP</a></li>
            <li><a href="siteconfig.php#qiangad" target="frmright">广告设置</a></li>
