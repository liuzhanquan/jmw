...
function openwindow(pageurl,iWidth,iHeight,inputId="img",imgId="showimg"){
var iTop = (window.screen.availHeight-30-iHeight)/2; //获得窗口的垂直位置;
var iLeft = (window.screen.availWidth-10-iWidth)/2; //获得窗口的水平位置;
uploadinputIdName = inputId;
uploadImgIdName = imgId;
...
document.getElementById(uploadinputIdName).value=value;
document.getElementById(uploadImgIdName).innerHTML="<img src='"+value+"' width=120>";
}
